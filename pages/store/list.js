    ...
    <>
      <div className="banner-container">
        ...
        <div className={[list.vertical, 'd-flex', 'flex-column'].join(' ')}>
          <img src="/pic2.jpg" className={list.pic2} />
          <img src="/pic3.jpg" className={list.pic3} />
          <img src="/pic4.jpg" className={list.pic4} />
        </div>
      </div>
        ...
        <div className="d-flex mx-auto" style={{ maxWidth: 1440 }}>
          <div>
            <div className={[list.title].join(' ')}>
              ...
              <div
                className={[list.roundedbox, 'rounded-pill', 'fw-normal'].join(
                  ' '
                )}
              >
                <div className={[list.citytext, 'fw-normal'].join(' ')}>
